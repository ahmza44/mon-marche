...
<div class="relative w-full overflow-hidden rounded-2xl mb-6" style="height: 280px;">
    ...
    <div id="slider" class="flex h-full transition-transform duration-500 ease-in-out">
        ...
        <div class="min-w-full h-full relative">
            <img src="{{ asset('storage/logo/selider2.jpg') }}"
            ...
            <div class="absolute inset-0 flex items-center justify-center text-center text-white px-6">
                <div>
                    <h2 class="text-2xl md:text-3xl font-bold">Produits frais 🥬</h2>
                    <p class="text-sm opacity-90">Qualité premium au meilleur prix</p>
                </div>
            </div>
        </div>
        ...
        {{-- SLIDE 2 --}}
        <div class="min-w-full h-full relative">
            <img src="{{ asset('storage/logo/selider3.jpeg') }}"
                 class="w-full h-full object-cover rounded-2xl">
            ...
            <div class="absolute inset-0 flex items-center justify-center text-center text-white px-6">
                <div>
                    <h2 class="text-2xl md:text-3xl font-bold">Viande & Volaille 🍗</h2>
                    <p class="text-sm opacity-90">Fraîcheur garantie chaque jour</p>
                </div>
            </div>
        </div>
        ...
        {{-- SLIDE 3 --}}
        <div class="min-w-full h-full relative">
            <img src="{{ asset('storage/logo/selider1.jpeg') }}"
                 class="w-full h-full object-cover rounded-2xl">
            ...
            <div class="absolute inset-0 flex items-center justify-center text-center text-white px-6">
                <div>
                    <h2 class="text-2xl md:text-3xl font-bold">Livraison rapide 🚚</h2>
                    <p class="text-sm opacity-90">Commandez et recevez chez vous</p>
                </div>
            </div>
        </div>
...
{{-- ═════════════ SEARCH ═════════════ --}}
<form action="{{ url('/') }}" method="GET" class="w-full md:max-w-md mb-6">
    <div class="relative">
        <input type="text"
               name="search"
